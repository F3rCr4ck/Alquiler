<?php
	...
	//Instancia al Controlador Usuario o Administrador
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(65,8,utf8_decode($datos_cliente['cliente_nombre']),0,0);
	$pdf->SetTextColor(33,33,33);
	...
	$pdf->Ln(6);
	$pdf->Cell(0,6,utf8_decode("Telefono: ".$datos_empresa['empresa_telefono']),0,0,'C');
	$pdf->Ln(6);
...
<body>
	...
	<?php include "../views/includ/script.php";?>
</body>
</html>
<?php } ?>