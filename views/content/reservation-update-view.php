...
<div class="container-fluid">
	...
	?>
            ...
            <div class="alert alert-danger text-center" role="alert">
                ...
                <p class="mb-0">Lo sentimos, no podemos actualizar el prestamo debido a que el prestamo se encuentra Finalizado.</p>
            </div>
            <?php }else{ ?>
	<div class="container-fluid form-neon">
        ...
        <?php
		    ...
		    $datos_cliente= $ins_cliente->datos_cliente_controlador("Unico",$logCont->encryption($campos['cliente_id']));
        ...
        ?>
            ...
            <div class="table-responsive">
                <table class="table table-dark table-sm">
                    ...
                    <tbody>
                        <?php
                            $datos_detalle=$ins_prestamo->datos_prestamo_controlador("Detalle",$logCont->encryption($campos['prestamo_codigo']));
        ...
        <input type="hidden" name="prestamo_codigo_up" value="<?php echo $logCont->encryption($campos['prestamo_codigo']); ?>">
            <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $campos['prestamo_pagado']; ?>" pattern="[0-9.]{1,10}" class="form-control" readonly="" id="prestamo_pagado" maxlength="10">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label for="prestamo_observacion" class="bmd-label-floating">*** Observación ***</label>
                                <input type="text" value="<?php echo $campos['prestamo_observacion']; ?>" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" class="form-control" name="prestamo_observacion_up" id="prestamo_observacion" maxlength="400">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="table-responsive" >
                        <table class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                <?php 
                                    $datos_pagos= $ins_prestamo->datos_prestamo_controlador("Pago",$logCont->encryption($campos['prestamo_codigo'])); 
                    ...
                    <div class="container-fluid">
                        <input type="hidden" name="pago_codigo_reg" value="<?php echo $logCont->encryption($campos['prestamo_codigo']); ?>">
                        <div class="form-group">
