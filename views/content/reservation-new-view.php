                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" data-form="loans" method="POST" autocomplete="off">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">-->
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Codigo" id="email">
                    </div>
                    <div class="form-group">
                        <label for="email">Descripcion</label>
                        <input type="email" class="form-control" placeholder="Descripcion" id="email">
                    </div>
            
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col form-group">
                                <label for="email">Compra</label>
                                <input type="text" class="form-control" id="email" placeholder="Compra" name="email">
                            </div>
                            <div class="col form-group">
                                <label for="email">Venta</label>
                                <input type="password" class="form-control" placeholder="Venta" name="pswd">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col form-group">
                            ...
                            <input type="text" class="form-control" id="email" placeholder="Stock" name="email">
                        </div>
                        <div class="col form-group">
                            <label for="email">Existencia</label>
                            <input type="password" class="form-control" placeholder="Existencia" name="pswd">
                        </div>
                    </div>
                ...
                <div class="container-fluid" id="tabla_items"></div>
                    ...
                    <!-- Modal footer 
                    <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="buscar_item()"><i class="fas fa-save fa-fw"></i> &nbsp; GUARDAR</button>
            ...
            <div class="modal fade" id="ModalAgregarItem" tabindex="-1" role="dialog" aria-labelledby="ModalAgregarItem" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form class="modal-content FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" data-form="default" method="POST" autocomplete="off">
                        <div class="modal-header">
...
<?php include_once "./views/includ/reservation.php"; ?>