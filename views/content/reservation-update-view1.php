    ...
    <div class="container-fluid">
        ...
        ?>
                ...
                <div class="container-fluid form-neon">
                    ...
                    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL;?>ajax/prestamoAjax.php" method="POST" data-form="update" autocomplete="off">
				    <input type="hidden" name="prestamo_id_update" value="<?php echo $pagina[1]; ?>">
                        <fieldset>
