							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_dni" class="bmd-label-floating">DNI: SIN PUNTOS</label>
										<input type="text" pattern="[0-9-]{8,8}" class="form-control" name="usuario_dni_reg" id="usuario_dni" maxlength="20">
									</div>
								</div>
