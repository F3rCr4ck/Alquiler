		...
		<!-- Page header -->
			...
			<?php 
				...
				//paginador_usuario_controlador($pagina,$registros,$privilegio,$id,$url,$busqueda);
				echo $ins_prestamo->paginador_prestamo_controlador($pagina[1],10,$_SESSION['privilegio_spm'],$pagina[0],"Busqueda",$_SESSION['fecha_inicio_prestamo'],$_SESSION['fecha_final_prestamo']);
			?>
