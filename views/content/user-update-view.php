...
<?php if($logCont->encryption($_SESSION['id_spm'])!= $pagina[1]){
							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9-]{8,8}" class="form-control" name="usuario_dni_up" id="usuario_dni" maxlength="20" value="<?php echo $campos['usuario_dni']; ?>" >
									</div>
								</div>
